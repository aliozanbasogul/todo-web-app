...
class FirebaseMethods {
  ...
  static async SaveListToUser(auth, listName, listItems) {
    try {
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot save list to Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      return {
        success: true,
        message: "List saved to user in Firestore successfully",
      };
    } catch (error) {
  ...
  static async GetListsFromUser(auth) {
    try {
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot get lists from Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      if (userDoc.exists()) {
        ...
        return {
          success: true,
          message: "Lists found in Firestore",
  ...
  static async DeleteListFromUser(auth, listName) {
    try {
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot delete list from Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      return {
        success: true,
        message: "List deleted from user in Firestore successfully",
      };
    } catch (error) {
      console.error(
        "Error deleting list from user in Firestore: ",
        error.message
      );
      return { success: false, message: error.message };
    }
  ...
  static async AddItemToList(auth, listName, item) {
    try {
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot add item to list in Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      return {
        success: true,
        message: "Item added to list in Firestore successfully",
      };
    } catch (error) {
  ...
  static async EditItem(auth, listName, index, newItemValue) {
    try {
      const user = auth.currentUser;
      const userUid = user ? user.uid : null;
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot edit item in Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      console.log("Item edited in Firestore successfully.");
      return {
        success: true,
        message: "Item edited in Firestore successfully",
      };
    } catch (error) {
      console.error("Error editing item in Firestore: ", error.message);
      return { success: false, message: error.message };
    }
  }

  static async DeleteItemFromList(auth, listName, itemIndex) {
    try {
      const user = auth.currentUser;
      const userUid = user ? user.uid : null;
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot delete item from Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      console.log("Item deleted from Firestore successfully.");
      return {
        success: true,
        message: "Item deleted from Firestore successfully",
      };
    } catch (error) {
      console.error("Error deleting item from Firestore: ", error.message);
      return { success: false, message: error.message };
    }
  }

  static async EditListName(auth, oldListName, newListName) {
    try {
      const user = auth.currentUser;
      const userUid = user ? user.uid : null;
      ...
      if (!userUid) {
        console.error(
          "User is not authenticated, cannot edit list name in Firestore."
        );
        return { success: false, message: "User is not authenticated" };
      }
      ...
      await setDoc(userDocRef, { lists: updatedLists }, { merge: true });

      console.log("List name edited successfully in Firestore.");
      return {
        success: true,
        message: "List name edited successfully in Firestore",
      };
    } catch (error) {
      console.error("Error editing list name in Firestore: ", error.message);
      return { success: false, message: error.message };
    }
  }

  static async DeleteList(auth, listName) {
    try {
      const user = auth.currentUser;
      const userUid = user ? user.uid : null;
      ...
      console.log("List deleted from Firestore successfully.");
      return {
        success: true,
        message: "List deleted from Firestore successfully",
      };
    } catch (error) {
      console.error("Error deleting list from Firestore: ", error.message);
      return { success: false, message: error.message };
    }
  }
}
